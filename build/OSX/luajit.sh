...
make -C $LUAJIT -j BUILDMODE=dynamic CC="clang $FLAGS -arch i386"   LUAJIT_SO=luajit.dylib TARGET_DYLIBPATH=luajit.dylib cleaner
...
make -C $LUAJIT -j BUILDMODE=dynamic CC="clang $FLAGS -arch x86_64" LUAJIT_SO=luajit.dylib TARGET_DYLIBPATH=luajit.dylib cleaner
