...
make -C $LUAJIT -j BUILDMODE=dynamic CC="gcc-4.2 -mmacosx-version-min=10.4 -arch i386" LUAJIT_SO=libluajit.dylib cleaner
make -C $LUAJIT -j BUILDMODE=dynamic CC="gcc-4.2 -mmacosx-version-min=10.4 -arch i386" LUAJIT_SO=libluajit.dylib amalg
mv $LUAJIT/src/luajit luajit32.tmp
mv $LUAJIT/src/libluajit.dylib libluajit32.dylib.tmp
make -C $LUAJIT -j BUILDMODE=dynamic CC="gcc-4.2 -mmacosx-version-min=10.4 -arch x86_64" LUAJIT_SO=libluajit.dylib cleaner
make -C $LUAJIT -j BUILDMODE=dynamic CC="gcc-4.2 -mmacosx-version-min=10.4 -arch x86_64" LUAJIT_SO=libluajit.dylib amalg
