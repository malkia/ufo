...
make -f Makefile.win32 CFG=release CC="cl /Oy /Os /GL /Zi /GF /Fd%LB_PROJECT_NAME%.pdb /arch:SSE2" AR="link /LIB" LD="link /LTCG /PDB:%LB_PROJECT_NAME%.pdb /RELEASE /SWAPRUN:NET /SWAPRUN:CD %LB_OBJS% opengl32.lib maglev.obj"
