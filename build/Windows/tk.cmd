...
cl %LB_CL_OPTS% -Fe%NAME%.dll -I win -I generic -I xlib -I bitmaps -I ..\tcl\generic -Dinline=__inline -W0 @sources.tmp USER32.LIB GDI32.LIB %LB_ROOT%/bin/Windows/%LB_TARGET_ARCH%/tcl.lib
