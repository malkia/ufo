...
cl -MD -Fd%LB_PROJECT_NAME%.pdb -Od -Z7 -MP -Fe%NAME%.dll -DBUILD_tk -I win -I generic -I xlib -I bitmaps -I ..\tcl\generic -Dinline=__inline -W0 @sources.tmp USER32.LIB GDI32.LIB %LB_ROOT%/bin/Windows/%LB_TARGET_ARCH%/tcl.lib  /link"%LB_LINK_OPTS%"
