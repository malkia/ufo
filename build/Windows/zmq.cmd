...
cl %LB_CL_OPTS% -Dssize_t=SSIZE_T -EHsc -Fe%NAME%.dll -LD -DZMQ_HAVE_OPENPGM=1 -DFD_SETSIZE=1024 -DDLL_EXPORT=1 -DNDEBUG=1 -I.. -I..\..\src -I"%~dp0\include" -I"%LB_PROJECT_ROOT%\..\openpgm\pgm\include" -DNOMINMAX @sources.tmp /link"%LB_LINK_OPTS% ws2_32.lib rpcrt4.lib"
