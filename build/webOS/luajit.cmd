...
pushd "%ROOT%" && git clean -fdx && make -j amalg LUAJIT_SO=luajit.so TARGET_SONAME=luajit.so BUILDMODE=dynamic TARGET_DYNXLDOPTS=-Wl,-rpath,'$$\ORIGIN' CROSS=arm-none-linux-gnueabi- TARGET=arm TARGET_SYS=Linux CCDEBUG=-g && popd
