...
@setlocal
@set LJCOMPILE=cl /nologo /c /MT /O2 /W3 /D_CRT_SECURE_NO_DEPRECATE /wd4005
...
:AMALGDLL
%LJCOMPILE% /DLUA_BUILD_AS_DLL ljamalg.c
%LJCOMPILE% /D"main=__declspec(dllexport) luajit_main" luajit.c
%LJLINK% /DLL /out:lua51.dll ljamalg.obj lj_vm.obj luajit.obj
:MTDLL
