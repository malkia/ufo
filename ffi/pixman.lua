...
local libs = ffi_pixman_libs or {
   OSX     = { x86 = "bin/pixman.dylib", x64 = "bin/pixman.dylib" },
   Windows = { x86 = "bin/pixman32.dll", x64 = "bin/pixman64.dll" },
   Linux   = { x86 = "bin/pixman32.so",  x64 = "bin/pixman64.so"  },
   BSD     = { x86 = "bin/pixman32.so",  x64 = "bin/pixman64.so"  },
   POSIX   = { x86 = "bin/pixman32.so",  x64 = "bin/pixman64.so"  },
   Other   = { x86 = "bin/pixman32.so",  x64 = "bin/pixman64.so"  },
}
...
replicate(""
..[[
   pixman_bool_t <A>invert(         <A>*, const <A>* );
   pixman_bool_t <A>point(    const <A>*, pixman_vector_t* );
   void          <A>point_3d( const <A>*, <A>* );
   void          <A>multiply(       <A>*, const <A>*, const <A>* );
   void          <A>init_scale(     <A>*, <S> x, <S> y );
   pixman_bool_t <A>transform_scale                 (struct pixman_f_transform       *forward,
							   struct pixman_f_transform       *reverse,
							   double                           sx,
							   double                           sy);
   void          pixman_<A>transform_init_rotate           (struct pixman_f_transform       *t,
							   double                           cos,
							   double                           sin);
   pixman_bool_t pixman_<A>transform_rotate                (struct pixman_f_transform       *forward,
							   struct pixman_f_transform       *reverse,
							   double                           c,
							   double                           s);
   void          pixman_<A>transform_init_translate        (struct pixman_f_transform       *t,
							   double                           tx,
							   double                           ty);
   pixman_bool_t pixman_<A>transform_translate             (struct pixman_f_transform       *forward,
							   struct pixman_f_transform       *reverse,
							   double                           tx,
							   double                           ty);
   pixman_bool_t pixman_<A>transform_bounds                (const struct pixman_f_transform *t,
							   struct pixman_box16             *b);
   void          pixman_<A>transform_init_identity         (struct pixman_f_transform       *t);
]],
{ "<A>"="pixman_transform",   "<S>"="pixman_fixed_t" },
{ "<A>"="pixman_f_transform", "<S>"="double" },
 })
..[[
